...
class TestUser(unittest.TestCase):
    ...
    def setUpClass(cls):
        cls.my_user = User()
        cls.my_user.first_name = "Erick"
        cls.my_user.last_name = "Francis"
        cls.my_user.email = "erickfrancis@gmail.com"
        cls.my_user.password = "erick1234"
    ...
    def test_style_check(self):
        ...
        x = stingo.check_files(['models/user.py'])
