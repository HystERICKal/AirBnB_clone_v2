...
class TestPlace(unittest.TestCase):
    ...
    def setUpClass(cls):
        cls.place1 = Place()
        cls.place1.city_id = "Nai"
        cls.place1.user_id = "Erick"
        cls.place1.name = "KICC"
        cls.place1.description = "Zakayo was here"
        cls.place1.number_rooms = 1
        cls.place1.number_bathrooms = 4
        cls.place1.max_guest = 2
        cls.place1.price_by_night = 20000
    ...
    def test_style_check(self):
        ...
        x = stingo.check_files(['models/place.py'])
